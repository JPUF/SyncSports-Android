[app](../../../index.md) / [com.jlbennett.syncsports.util](../../index.md) / [MatchTime](../index.md) / [CREATOR](./index.md)

# CREATOR

`companion object CREATOR : `[`Creator`](https://developer.android.com/reference/android/os/Parcelable/Creator.html)`<`[`MatchTime`](../index.md)`>`
